#张晙优 Percy Joonwoo Jang, 1800094804@pku.edu.cn
#Recall from Part B, instruction required for IADDQ instruction is as following:
#Fetch: 
#icode:ifun <- M1[PC]
#rA: rB <- M1[PC+1]
#valC <- M8[PC+2]
...
#PC <- valP
#
#Not much edition is required, we only need to make sure IIADDQ is correctly
#defined in instr_valid, need_regids, need_valC, d_srcB, d_dstE, aluB, set_CC.
#If those are implemented, IADDQ will go as the procedure described above.
#
#
#
